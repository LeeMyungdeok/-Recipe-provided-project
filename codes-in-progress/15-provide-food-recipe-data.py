# json server의 데이터 검증과정

# json server connect : json-server --watch ./bin_FoodData.json --host 0.0.0.0 --port 5000
# json server URL : http://192.168.1.78:5000/Food

# json server connect : json-server --watch ./Trash.json --host 0.0.0.0 --port 5001
# json server URL : http://192.168.1.78:5001/trash
